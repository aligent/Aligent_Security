 ...
 * Not possible to use a rewrite because the class is inherited
 * and instantiated via parent::__construct calls e.g. Mage_Adminhtml_Block_Dashboard_Tab_Orders
 */
...
class Mage_Adminhtml_Block_Dashboard_Graph extends Mage_Adminhtml_Block_Dashboard_Abstract
{
    ...
    public function getChartUrl($directUrl = true)
    {
        ...
        if ($directUrl) {
            ...
            /***
             *
             * Patch SUPEE-1868 affects the following line
             *
             */
